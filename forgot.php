...
<head>
 ...
 <body>
 	<div id="nav"> <br>
      ...
      <br><br><br> <input type="email" name="email" placeholder="Email address:"> <br>
      <br> 
      <a href="#"><button type="button" class="btn btn-sign">Reset Password</button></a> <br> <br> <br>
     Didn't recive the email? <u><a href="index.php" >Send again</a></u>
